...
export default function VipPublicForm({ token, apiBase, formMeta, onSuccess, onError }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "grid", gap: 24 }}>
      ...
      <section>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16 }}>
          ...
          <input
            ...
            style={{
              ...baseInputStyle,
              ...(email.trim() && !isEmailValid(email) ? { border: "1px solid #ef4444" } : {}),
            }}
          />
          <input
      ...
      <section>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
          <select value={participationMen} onChange={(e) => setParticipationMen(e.target.value)} className="tropical-input" style={{ ...baseInputStyle, background: "#fff", ...(participationMen ? {} : { border: "1px solid #ef4444" }) }}>
          ...
          <select value={participationWomen} onChange={(e) => setParticipationWomen(e.target.value)} className="tropical-input" style={{ ...baseInputStyle, background: "#fff", ...(participationWomen ? {} : { border: "1px solid #ef4444" }) }}>
          ...
          <select value={donationAbility} onChange={(e) => setDonationAbility(e.target.value)} className="tropical-input" style={{ ...baseInputStyle, background: "#fff" }}>
          ...
          <select value={blessingOption} onChange={(e) => setBlessingOption(e.target.value)} className="tropical-input" style={{ ...baseInputStyle, background: "#fff" }}>
