  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "grid", gap: 24 }}>
      <div style={{ textAlign: "center" }}>
        <h1 style={{ fontSize: 34, margin: 0, color: "#0f172a", fontWeight: 700, marginBottom: '8px' }}>ברוכים הבאים!</h1>
        <p style={{ fontSize: 20, marginTop: 0, color: "#334155", fontWeight: 400 }}>נודה על עזרתכם במילוי השאלון לגבי הושבה כדי שנוכל לכבדכם כיאות</p>
      </div>
