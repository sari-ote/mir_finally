	...
	return (
		<div style={{ background: '#f3f4f6', borderRadius: 16, padding: 20, position: 'relative' }}>
			...
			<div style={{ textAlign: 'center', marginBottom: 22 }}>
				<div style={{ fontSize: 36, fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>ברוכים הבאים!</div>
				<div style={{ fontSize: 28, fontWeight: 400, color: '#0f172a' }}>נודה על עזרתכם במילוי השאלון לגבי הושבה כדי שנוכל לכבדכם כיאות</div>
			</div>
