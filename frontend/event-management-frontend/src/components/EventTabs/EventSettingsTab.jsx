...
export default function EventSettingsTab({ eventId }) {
  ...
  const fitMapToScreen = useCallback(() => {
    try {
      ...
      console.error('Error in fitMapToScreen:', e);
    }
  }, []);
    ...
    <div style={{ background: '#f8fafc', borderRadius: 16, boxShadow: '0 2px 12px #0001', padding: 32, margin: '30px auto', maxWidth: '95%', width: '100%', position: 'relative' }}>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 16 }}>
              <input
                type="number"
                min={1}
                placeholder="כמות כסאות (קובע את גודל השולחן)"
                value={newTable.size}
              ...
              <div style={{ position: 'relative', width: '100%' }}>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', direction: 'rtl' }}>
                    {newTable.shape === 'circular' && (
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0 }}>
                        <circle cx="10" cy="10" r="8" stroke="#09b0cb" strokeWidth="1.8" fill="none"/>
                      </svg>
                    )}
                    {newTable.shape === 'rectangular' && (
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0 }}>
                        <rect x="3" y="3" width="14" height="14" stroke="#09b0cb" strokeWidth="1.8" fill="none" rx="1.5"/>
                      </svg>
                    )}
                    {newTable.shape === 'oblong' && (
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" style={{ flexShrink: 0 }}>
                        <rect x="3" y="6" width="14" height="8" stroke="#09b0cb" strokeWidth="1.8" fill="none" rx="1.5"/>
                      </svg>
                    )}
                    <span style={{ fontFamily: "'Rubik', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
                      {newTable.shape === 'circular' ? 'עגול' : newTable.shape === 'rectangular' ? 'מרובע' : 'מלבן (ארוך)'}
                    </span>
                  </div>
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" style={{ flexShrink: 0, transform: showShapeDropdown ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.2s ease' }}>
                    <path d="M3.5 5L7 8.5L10.5 5" stroke="#09b0cb" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
                {showShapeDropdown && (
                  <>
                    ...
                    <div style={{
                      ...
                      {[
                        { value: 'circular', label: 'עגול', icon: (
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <circle cx="10" cy="10" r="8" stroke="#09b0cb" strokeWidth="1.8" fill="none"/>
                          </svg>
                        )},
                        { value: 'rectangular', label: 'מרובע', icon: (
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <rect x="3" y="3" width="14" height="14" stroke="#09b0cb" strokeWidth="1.8" fill="none" rx="1.5"/>
                          </svg>
                        )},
                        { value: 'oblong', label: 'מלבן (ארוך)', icon: (
                          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <rect x="3" y="6" width="14" height="8" stroke="#09b0cb" strokeWidth="1.8" fill="none" rx="1.5"/>
                          </svg>
                        )}
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() => {
                            setNewTable({ ...newTable, shape: option.value });
                          ...
                          style={{
                            ...
                            alignItems: 'center',
                            gap: '12px',
                            background: newTable.shape === option.value ? 'rgba(9, 176, 203, 0.08)' : 'transparent',
                            border: 'none',
                            cursor: 'pointer',
                            textAlign: 'right',
                            direction: 'rtl',
                            fontFamily: "'Rubik', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",
                            fontSize: '16px',
                            color: newTable.shape === option.value ? '#09b0cb' : '#10131A',
                            transition: 'all 0.2s ease'
                          }}
                          onMouseEnter={(e) => {
                            if (newTable.shape !== option.value) {
      ...
      {showMap && (
        <div 
          ...
          style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.9)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
          <div 
            onClick={(e) => e.stopPropagation()}
            style={{ background: 'white', borderRadius: 16, padding: 24, width: '95vw', height: '90vh', overflow: 'hidden', display: 'flex', flexDirection: 'column', cursor: 'default' }}>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: 16, flexShrink: 0, position: 'relative' }}>
              <h3 style={{ margin: 0, fontWeight: 700, fontSize: 24, color: '#09b0cb', textAlign: 'center' }}>מפת האולם - מבט מלמעלה</h3>
              <button
                onClick={() => setShowMap(false)}
                style={{
                  position: 'absolute',
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.color = 'rgba(142, 142, 147, 1)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = 'transparent';
                  e.currentTarget.style.color = 'rgba(142, 142, 147, 0.8)';
                }}
              >
                <svg
                  width="24"
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginBottom: 16 }}>
              <div style={{ 
                ...
                >-</button>
                <span style={{ minWidth: 60, textAlign: 'center', fontWeight: 600, color: '#09b0cb', fontFamily: "'Rubik', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>{Math.round(zoom * 100)}%</span>
                <button 
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = 'rgba(9, 176, 203, 0.2)';
                  }}
                  onMouseLeave={(e) => {
            ...
            <div className="hall-map-container">
              ...
              >
                ...
                <div style={{
                  ...
                  bottom: 0,
                  backgroundImage: `
                    linear-gradient(rgba(9, 176, 203, 0.08) 1px, transparent 1px),
                    linear-gradient(90deg, rgba(9, 176, 203, 0.08) 1px, transparent 1px)
                  `,
                ...
                {/* הצג אלמנטי אולם */}
                  ...
                  <div
                    ...
                    style={{
                      ...
                      background: element.element_type === 'stage' 
                        ? 'linear-gradient(135deg, #09b0cb 0%, #0bc4e0 100%)' 
                        : 'linear-gradient(135deg, #34d399 0%, #10b981 100%)',
                        borderRadius: element.element_type === 'stage' ? '18px' : '999px',
                      color: 'white',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      ...
                      userSelect: 'none',
                        border: draggedElementType === 'hall_element' && draggedElementId === element.id 
                          ? '3px solid #ef4444' 
                  ...
                  >
                    ...
                    style={{
                      position: 'absolute',
                              ...
                              cursor: 'nw-resize',
                              zIndex: 20,
                              boxShadow: '0 2px 4px rgba(9, 176, 203, 0.3)'
                            }}
